  ...
  return (
    <footer className="bg-white text-gray-800 py-20 border-t border-gray-300">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <span className="text-sm leading-relaxed text-gray-700">{getEnderecoCompleto()}</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-700">{siteConfig.contato.telefone}</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <a href={`https://wa.me/${siteConfig.contato.whatsapp}`} className="text-sm text-gray-700 hover:text-[#957B4F] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="flex justify-between border-b border-gray-200 pb-2">
                <span>Seg — Sex</span>
                <span className="text-gray-800">08h - 18h</span>
              </li>
              <li className="flex justify-between border-b border-gray-200 pb-2">
                <span>Sábado</span>
                <span className="text-gray-800">08h - 12h</span>
              </li>
            ...
            <div className="space-y-6">
              {latestNews.map((noticia) => (
                <Link key={noticia.id} href={`/noticias/${noticia.slug}`} className="group block">
                  <p className="text-xs text-gray-500 mb-1 uppercase tracking-wider">{formatarData(noticia.date)}</p>
                  <p className="text-sm font-medium group-hover:text-[#957B4F] transition-colors line-clamp-2 text-gray-700">
                    {noticia.title}
                  </p>
                </Link>
              ))}
            ...
            <div className="flex gap-4">
              {['linkedin', 'facebook', 'instagram'].map((rede) => (
                <a 
                  ...
                  className="w-10 h-10 border border-gray-300 rounded-full flex items-center justify-center hover:border-[#957B4F] hover:text-[#957B4F] transition-all"
                >
        ...
        {/* Copyright */}
        <div className="border-t border-gray-300 mt-20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
