          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <svg className="w-5 h-5 text-[#957B4F] mt-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4">
                <svg className="w-5 h-5 text-[#957B4F] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
