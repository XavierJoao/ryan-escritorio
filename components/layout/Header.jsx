...
const Header = () => {
  return (
    <header className="sticky top-0 z-50" style={{ backgroundColor: '#424144', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
      <div className="container mx-auto px-6 md:px-12 py-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            />
            <span className="text-white font-bold uppercase tracking-widest text-lg font-montserrat-alternates">Lopes Pinto Advogados</span>
          </div>
